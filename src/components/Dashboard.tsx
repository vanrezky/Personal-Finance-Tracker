  ...
  if (!transactions) {
    return (
      <div className="space-y-6">
        <div className="bg-slate-900 p-6 rounded-[28px] shadow-xl relative overflow-hidden">
  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 p-6 text-white shadow-[0_20px_60px_rgba(15,23,42,0.24)]"
      >
        ...
        <div className="relative z-10 space-y-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="text-4xl font-semibold tracking-tight sm:text-[2.75rem]">
          ...
          <p className="max-w-xs text-sm leading-6 text-slate-300">{highlightMessage}</p>
      ...
      >
        <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm shadow-slate-200/60 backdrop-blur-sm">
          <div className="mb-2 flex items-center gap-2 text-slate-500">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.2em]">Siklus aktif</span>
          </div>
          <p className="text-sm font-semibold text-slate-900">{format(cycleStart, 'dd MMM')} - {format(cycleEnd, 'dd MMM')}</p>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm shadow-slate-200/60 backdrop-blur-sm">
          <div className="mb-2 flex items-center gap-2 text-slate-500">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.2em]">Payday</span>
          </div>
          <p className="text-sm font-semibold text-slate-900">Tanggal {payday} tiap bulan</p>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.div
            ...
            className="rounded-[28px] border border-emerald-100/80 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-sm shadow-emerald-100/70"
          >
            <div className="mb-3 flex items-center gap-2 text-emerald-700">
              <div className="rounded-full bg-emerald-100 p-2">
                <ArrowDownRight className="h-4 w-4" />
              </div>
              <span className="text-xs font-bold uppercase tracking-[0.18em]">Pemasukan</span>
            </div>
            <p className="text-lg font-bold text-emerald-950">{formatCurrency(cycleIncome)}</p>
          ...
          <motion.div
            ...
            className="rounded-[28px] border border-rose-100/80 bg-gradient-to-br from-rose-50 to-white p-5 shadow-sm shadow-rose-100/70"
          >
            <div className="mb-3 flex items-center gap-2 text-rose-700">
              <div className="rounded-full bg-rose-100 p-2">
                <ArrowUpRight className="h-4 w-4" />
              </div>
              <span className="text-xs font-bold uppercase tracking-[0.18em]">Pengeluaran</span>
            </div>
            <p className="text-lg font-bold text-rose-950">{formatCurrency(cycleExpense)}</p>
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-indigo-500">Quick insight</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/60">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Saldo total</p>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/60">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Pemasukan total</p>
